...
<head>
  ...
  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .nav-admin-btn { background:var(--yellow); color:var(--black); font-family:'DM Sans',sans-serif; font-weight:700; font-size:12px; padding:7px 14px; text-decoration:none; letter-spacing:1px; text-transform:uppercase; white-space:nowrap; }
...
<nav>
  <a href="/" class="nav-logo">
    <img src="/logo.png" alt="A2KF Suplementos" style="height:44px;width:auto;display:block;" />
  </a>
  <div class="nav-links">
    <a href="/">Blog</a>
